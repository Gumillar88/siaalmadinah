                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                {{ isset($_schoollevels[$value->school_grade_id]) ? $_schoollevels[$value->school_grade_id] : "-" }}
                            </td>
                            <td class="text-center">{{ $value->name }}</td>
                            <td class="text-center">
                                <span>
                                    <a class="btn btn-primary fs-15"
                                        href="{{ URL::to('/master/class/edit').'/'.base64_encode($value->id) }}">
                                        <i class="ri-edit-2-line"></i>
                                    </a>
                                    <a class="btn btn-danger fs-15"
                                        href="{{ URL::to('/master/class/remove').'/'.base64_encode($value->id) }}">
